...
export default async function CompanyDetailPage({
  ...
  const companyData: Company = {
    ...
    company_size: (company.company_size as Company['company_size']) ?? null,
    status: (company.status as Company['status']) ?? 'prospect',
    notes: company.notes ?? null,
    tags: company.tags ?? [],
    ai_enriched: company.ai_enriched ?? false,
    ai_enrichment_data: (company as Record<string, unknown>).ai_enrichment_data as Record<string, unknown> | null ?? null,
