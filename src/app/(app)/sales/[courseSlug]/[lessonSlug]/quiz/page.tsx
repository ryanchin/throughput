...
import QuizPageClient from '@/app/(app)/training/[courseSlug]/[lessonSlug]/quiz/QuizPageClient'

export default async function SalesQuizPage({
  params,
}: {
  ...
  // Sales zone requires sales or admin role
  ...
  // Fetch course — must be in sales zone
